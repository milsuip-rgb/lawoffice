...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (savedCases) {
      setCasesList(JSON.parse(savedCases));
    } else {
    ...
    if (savedReviews) {
      ...
      setReviewsList([
        { text: "복잡한 법률 용어도 쉽게 설명해주셔서 이해하기 쉬웠고, 방향성을 명확히 제시해 주셔서 안심하고 진행할 수 있었어요.", result: "혐의없음", bg: "/client_review_1.png" },
        { text: "장작 1년간의 싸움 끝에 승소를 받아주셔서 정말 감사했습니다. 정 변호사님 덕분에 소중한 일상을 되찾았습니다.", result: "무죄", bg: "/client_review_2.png" },
        { text: "혼자라고 생각했는데 들어주신 분이 계셔서 맘이 편해졌어요. 진심으로 감사드립니다.", result: "무죄", bg: "/client_review_3.png" }
      ]);
    }
  }, []);
